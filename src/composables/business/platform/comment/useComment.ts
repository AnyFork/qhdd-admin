import { deleteComment, getCommentList, updateComment } from '@/service/platform/comment';
import { DataTableColumns } from 'naive-ui'
import ServiceComment from '@/components/platform/comment/ServiceComment.vue'
/**
 * 顾客评论模块
 * @returns 
 */
