...
const { shopOption = [], serviceOption = [], deliveryOption = [], shopAreaOption = [], shopCategoryOption = [], chainOptions = [] } = defineProps<{ shopOption: []; serviceOption: []; deliveryOption: []; shopAreaOption: []; shopCategoryOption: []; chainOptions: [] }>()
const emit = defineEmits<{ refresh: [] }>()
const { formRef, moduleValue, rules, addStoreInfo, loading, message } = useStore()
