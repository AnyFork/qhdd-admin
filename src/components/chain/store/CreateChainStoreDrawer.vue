        ...
        <n-drawer-content title="创建门店" closable>
            <n-form ref="formRef" :label-width="100" :model="moduleValue" :rules="rules" size="medium" label-placement="left" style="margin-top: 20px">
                ...
                <n-form-item label="所属连锁店">
                    <n-select v-model:value="moduleValue.chainid" :options="chainOptions" placeholder="请选择连锁店" disabled clearable class="w-180px" />
                </n-form-item>
...
const { formRef, moduleValue, rules, addStoreInfo, loading, message } = useChainStore()
