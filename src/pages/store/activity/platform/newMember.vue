    ...
    <div class="">
        ...
        <n-form :model="model" label-placement="left" label-width="200" class="my-6">
            ...
            <div class="my-20 px-100px flex gap-6">
                <n-button v-if="model.mallNewMember!.plateform_charge==0" type="primary" class="w-200px" :loading="loading" :disabled="!isAdmin" @click="submitActivity">{{ isEdit ? '编辑活动' : '创建活动' }}</n-button>
