...
>()
const { storeListData, pagination, tableData, updateStoreStatusBatch, loading, columns, message, CreateShow, searchForm, handleCheck, checkedRowKeysRef, shopOption, deliveryOption, serviceOption, categoryPageList } = useStore()
const { storeCategoryList } = useCategory()
