 ...
 * @returns 
 */
export const storeListPlatformSelect = async (params?: Partial<order.orderInfo>) => await platformAxios.get(`${storeListPlatformApi}?${qs.stringify({ pageNo: 1, pageSize: 1000, ...params })}`)
